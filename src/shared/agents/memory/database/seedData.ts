...
function seedSkills(db: any): void {
  ...
  const skills = [
    ...
    ["Bluff", 5, "Quick deception, misdirection, verbal tricks", "social", 0, null],
    ...
    ["Research", 20, "Research in libraries, archives, databases", "knowledge", 0, null],
    ...
    ["Perception", 25, "Finding hidden objects, spotting clues, noticing concealed things", "investigation", 0, null],
    ...
    ["Brawling", 25, "Hand-to-hand combat, punching, kicking", "combat", 0, null],
    ...
    ["Forbidden Lore", 0, "Knowledge of forbidden truths (reduces max Sanity)", "mythos", 1, null],
  ];
...
function seedWeapons(db: any): void {
  ...
  const weapons = [
    ...
    ["Brass Knuckles", "Brawling", "1d3+1+DB", "touch", 1, null, null, "1920s,modern"],
    ["Whip", "Whip", "1d3+half DB", "10 feet", 1, null, null, "1920s"],
    ["Burning Torch", "Brawling", "1d6+burn", "touch", 1, null, null, "1920s,modern"],
    ["Chainsaw", "Brawling", "2d8", "touch", 1, null, 95, "modern"],
    ["Leather-wrapped Club", "Brawling", "1d8+DB", "touch", 1, null, null, "1920s,modern"],
    ["Large Club", "Brawling", "1d8+DB", "touch", 1, null, null, "1920s,modern"],
    ["Small Club", "Brawling", "1d6+DB", "touch", 1, null, null, "1920s,modern"],
    ...
    ["Large Knife", "Brawling", "1d8+DB", "touch", 1, null, null, "1920s,modern"],
    ["Medium Knife", "Brawling", "1d4+2+DB", "touch", 1, null, null, "1920s,modern"],
    ["Small Knife", "Brawling", "1d4+DB", "touch", 1, null, null, "1920s,modern"],
    ...
    ["Lance (Cavalry)", "Spear", "1d8+1+DB", "touch", 1, null, null, "1920s,modern"],
    ["Thrown Spear", "Throw", "1d8+half DB", "STR yards", 1, null, null, "rare"],
    ["Large Sword", "Sword", "1d8+1+DB", "touch", 1, null, null, "1920s,modern"],
    ["Medium Sword", "Sword", "1d6+1+DB", "touch", 1, null, null, "1920s,modern"],
    ...
    [".22 Short Auto Pistol", "Pistol", "1d6", "10 yards", 3, 6, 100, "1920s,modern"],
    [".25 Short Pistol (Derringer)", "Pistol", "1d6", "3 yards", 1, 1, 100, "1920s"],
    [".32 or 7.65mm Revolver", "Pistol", "1d8", "15 yards", 3, 6, 100, "1920s,modern"],
    [".32 or 7.65mm Auto Pistol", "Pistol", "1d8", "15 yards", 3, 8, 99, "1920s,modern"],
    [".357 Magnum Revolver", "Pistol", "1d8+1d4", "15 yards", 3, 6, 100, "modern"],
    [".38 or 9mm Revolver", "Pistol", "1d10", "15 yards", 3, 6, 100, "1920s,modern"],
    ...
    [".44 Magnum Revolver", "Pistol", "1d10+1d4+2", "15 yards", 3, 6, 100, "modern"],
    [".45 Revolver", "Pistol", "1d10+2", "15 yards", 3, 6, 100, "1920s,modern"],
    [".45 Auto Pistol", "Pistol", "1d10+2", "15 yards", 3, 7, 100, "1920s,modern"],
    ["Desert Eagle", "Pistol", "1d10+1d6+3", "15 yards", 3, 7, 94, "modern"],

    // ===== RIFLES =====
    [".58 Springfield Rifle", "Rifle", "1d10+4", "60 yards", 1, 1, 95, "rare"],
    [".22 Lever-action Rifle", "Rifle", "1d6+1", "30 yards", 1, 6, 99, "1920s,modern"],
    [".30 Carbine", "Rifle", "2d6", "50 yards", 1, 6, 98, "1920s,modern"],
    [".45 Martini-Henry Rifle", "Rifle", "1d8+1d6+3", "80 yards", 1, 1, 100, "1920s"],
    ["Colonel Moran's Air Rifle", "Rifle", "2d6+1", "20 yards", 1, 1, 88, "1920s"],
    ["Garand M1/M2 Rifle", "Rifle", "2d6+4", "110 yards", 1, 8, 100, "WWII+"],
    ["SKS Semi-Auto Rifle", "Rifle", "2d6+1", "90 yards", 2, 10, 97, "modern"],
    [".303 (7.7mm) Lee-Enfield", "Rifle", "2d6+4", "110 yards", 1, 5, 100, "1920s,modern"],
    [".30-06 (7.62mm) Bolt Rifle", "Rifle", "2d6+4", "110 yards", 1, 5, 100, "1920s,modern"],
    [".30-06 (7.62mm) Semi-Auto", "Rifle", "2d6+4", "110 yards", 1, 5, 100, "modern"],
    [".444 (11.28mm) Marlin Rifle", "Rifle", "2d8+4", "110 yards", 1, 5, 98, "modern"],
    ["Elephant Gun (Double Barrel)", "Rifle", "3d6+4", "100 yards", 2, 2, 100, "1920s,modern"],

    // ===== SHOTGUNS =====
    ["20-gauge Shotgun (Double)", "Rifle", "2d6/1d6/1d3", "10/20/50 yards", 2, 2, 100, "1920s"],
    ["16-gauge Shotgun (Double)", "Rifle", "2d6+2/1d6+1/1d4", "10/20/50 yards", 2, 2, 100, "1920s"],
    ["12-gauge Shotgun (Double)", "Rifle", "4d6/2d6/1d6", "10/20/50 yards", 2, 2, 100, "1920s,modern"],
    ["12-gauge Pump Shotgun", "Rifle", "4d6/2d6/1d6", "10/20/50 yards", 1, 5, 100, "modern"],
    ["12-gauge Semi-Auto Shotgun", "Rifle", "4d6/2d6/1d6", "10/20/50 yards", 2, 5, 100, "modern"],
    ["Sawed-off 12-gauge Double", "Rifle", "4d6/1d6", "5/10 yards", 2, 2, 100, "1920s"],
    ["10-gauge Shotgun (Double)", "Rifle", "4d6+2/2d6+1/1d4", "10/20/50 yards", 2, 2, 100, "1920s,rare"],
    ["Benelli M3 12-gauge (Folding)", "Rifle", "4d6/2d6/1d6", "10/20/50 yards", 2, 7, 100, "modern"],
    ["SPAS 12-gauge (Folding)", "Rifle", "4d6/2d6/1d6", "10/20/50 yards", 1, 8, 98, "modern"],
    ...
    ["FN FAL Light Automatic", "Rifle", "2d6+4", "110 yards", 3, 20, 97, "modern"],
    ...
    // ===== SUBMACHINE GUNS =====
    ["Bergmann MP18/MP28", "Submachine Gun", "1d10", "20 yards", 3, 32, 96, "1920s"],
    ["Heckler-Koch MP5", "Submachine Gun", "1d10", "20 yards", 3, 30, 97, "modern"],
    ["MAC-11", "Submachine Gun", "1d10", "15 yards", 3, 32, 96, "modern"],
    ["Scorpion SMG", "Submachine Gun", "1d8", "15 yards", 3, 20, 96, "modern"],
    ["Thompson SMG", "Submachine Gun", "1d10+2", "20 yards", 3, 30, 96, "1920s"],
    ["Uzi Mini SMG", "Submachine Gun", "1d10", "20 yards", 3, 32, 98, "modern"],

    // ===== MACHINE GUNS =====
    ["M1882 Gatling Gun", "Machine Gun", "2d6+4", "100 yards", 999, 200, 96, "1920s,rare"],
    ["M1918 Browning Auto Rifle", "Machine Gun", "2d6+4", "90 yards", 3, 20, 100, "1920s"],
    ["M1917A1 Browning Heavy MG", "Machine Gun", "2d6+4", "150 yards", 999, 250, 96, "1920s"],
    ["Bren Light Machine Gun", "Machine Gun", "2d6+4", "110 yards", 3, 30, 96, "1920s"],
    ["Lewis Light Machine Gun", "Machine Gun", "2d6+4", "110 yards", 999, 97, 96, "1920s"],
    ["Minigun", "Machine Gun", "2d6+4", "200 yards", 999, 4000, 98, "modern"],
    ["FN Minimi 5.56mm LMG", "Machine Gun", "2d6", "110 yards", 999, 200, 99, "modern"],
    ["Vickers MK1 Machine Gun", "Machine Gun", "2d6+4", "110 yards", 999, 250, 99, "1920s"],

    // ===== EXPLOSIVES & HEAVY WEAPONS =====
    ["Molotov Cocktail", "Throw", "2d6+burn", "STR yards", 1, null, 95, "1920s,modern"],
    ["Flare Gun", "Pistol", "1d10+1d3+burn", "10 yards", 1, 1, 100, "1920s,modern"],
    ["M79 Grenade Launcher", "Heavy Weapon", "3d10/2 yards", "20 yards", 1, 1, 99, "modern"],
    ...
    ["Flamethrower", "Flamethrower", "2d6+burn", "25 yards", 1, 10, 93, "1920s,modern"],
    ["Light Anti-tank Weapon", "Heavy Weapon", "8d10/1 yard", "150 yards", 1, 1, 98, "modern"],
  ];
