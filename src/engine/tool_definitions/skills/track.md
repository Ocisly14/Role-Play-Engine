...
- **Regular success**: The actor successfully identifies and follows a trail. They determine the direction of travel and can proceed to the next location along the quarry's path. Record the trail details and the tracking attempt as memory.event — footprint type, gait, approximate time since passage.
