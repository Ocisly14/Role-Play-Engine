...
## On Success
- **Regular success**: The actor determines the correct route or current position. Using a map, compass, stars, or landmarks, they orient themselves and can guide the group toward the destination without becoming lost.
...
- **Extreme success**: The actor has a precise and detailed understanding of their position and the terrain ahead. They identify shortcuts, safe shelter locations, or potential hazards along the route that a less skilled navigator would miss entirely.
