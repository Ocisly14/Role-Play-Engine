...
const TRANSITION_MATRIX: number[][] = [
  [  0.65,  0.10,  0.10, 0.02,  0.03,  0.05,  0.05 ],
  [  0.10,  0.45,  0.10, 0.20,  0.05,  0.00,  0.10 ],
  [  0.25,  0.15,  0.55, 0.00,  0.03,  0.02,  0.00 ],
  [  0.05,  0.35,  0.00, 0.50,  0.05,  0.00,  0.05 ],
  [  0.05,  0.05,  0.05, 0.05,  0.55,  0.00,  0.25 ],
  [  0.25,  0.00,  0.05, 0.03,  0.00,  0.67,  0.00 ],
  [  0.10,  0.00,  0.05, 0.05,  0.20,  0.00,  0.60 ],
];
