  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: '14px', lineHeight: '1.6' }}>
        <p><strong>{t('common:i18nTest.currentLanguage')}</strong> {language}</p>
        <p><strong>{t('common:i18nTest.i18nLanguage')}</strong> {i18n.language}</p>

        <hr style={{ margin: '10px 0', opacity: 0.3 }} />

        <p><strong>{t('common:i18nTest.commonNamespace')}</strong></p>
        ...
        <p><strong>{t('common:i18nTest.homeNamespace')}</strong></p>
        <ul style={{ margin: '5px 0', paddingLeft: '20px' }}>
        ...
        <p><strong>{t('common:i18nTest.gameNamespace')}</strong></p>
        <ul style={{ margin: '5px 0', paddingLeft: '20px' }}>
